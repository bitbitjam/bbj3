...
usecode	= $9101	;CHANGE! to the USE hexcode from P61con for a big 
...
P61Module:
		incbin "data/p61.princessmassacre"	;CIA, usecode $9159
		section	"CHIPDATA",data_c
P61Sample:
		incbin "data/smp.princessmassacre"	;CIA, usecode $9159
