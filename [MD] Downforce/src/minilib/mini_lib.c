...
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VDP_setTile( u16 plano, u16 tile, u16 x, u16 y ){
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// void VDP_fillBigTileMap u16 plano, int x1, int y1, int x2, int y2, int inicio_tiles){
...
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VDP_fillBigTileMap( u16 plano, const u16 *mapa, int x1, int y1, int x2, int y2, int tam, int inicio_tiles){
    ...
    for( y = y1; y <= y2; y++){
        *plctrl = GFX_WRITE_VRAM_ADDR(addr);
        ...
        for( x = x1; x <= x2; x++){
			...
			// compruebo si me he pasado del final del mapa -> vuelvo al principio
			if( x >= tam )
				*pwdata = inicio_tiles+mapa[(x % tam)+tam*y];
			else
...
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VDP_updateBigTileMap( u16 plano, const u16 *mapa, int x1, int y1, int y2, int tam, int inicio_tiles){
	...
	// miramos si leemos dentro o fuera del mapa y ajustamos
	//if( x1 < tam )
	//	src = &mapa[x1+tam*y1];
	//else
	src = &mapa[(x1%tam)+tam*y1];
    ...
    *pw = 0x8F00 | 2;
	...
	addr = plano + ((x1%64 + (planwidth * y1))<<1);
...
//
//////////////////////////////////////////////////////////////////////////////////////
void VDP_drawNumber(int num, u16 plan, u16 basetile, u16 x, u16 y, u8 mode){

    char str[16];

    intToStr(num, str, 1);

    VDP_drawText(str, plan, basetile, x, y, mode);
}

///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// void VDP_drawText(const char *str, u16 plan, u16 basetile, u16 x, u16 y, mode ){
// dibuja el texto str, en el plano plan, a partir del tile basetile, en x/y, horizontal o verticalmente
//
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void VDP_drawText(const char *str, u16 plan, u16 basetile, u16 x, u16 y, u8 mode){
	...
	if( mode )
		VDP_fillTileMap( plan, data, x, y, 1, len, basetile);
	else
