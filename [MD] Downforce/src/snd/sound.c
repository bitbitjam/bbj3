...
// PSG PSG PSG
//////////////////////////////////////////////////////////////////////////////////////
const u8 sfx01_data[sfx01_size]={
	0x00,0x01,0x00,0x04,0x02,0x00,0x09,0x00,0x11,0x00,0xc1,0xab,0x1f,0x10,0xfc,0x00,
	0x00,0x01,0xfc,0x00,0x0b,0xd5,0xab,0x1f,0x04,0xfc,0x00,0x00
};

const u8 sfx02_data[sfx02_size]={
	0x00,0x01,0x00,0x04,0x02,0x00,0x09,0x00,0x11,0x00,0xc0,0xd5,0x1f,0x10,0xfc,0x00,
	0x00,0x01,0xfc,0x00,0x05,0xd4,0xd5,0x1f,0x0a,0xfc,0x00,0x00
};
...
void psgFxPlay( u16 psg ){
	...
	*pb = 0xff;
	...
	PSGFX.data = (u8*) _PsgList[psg].data;
...
//////////////////////////////////////////////////////////////////////////////////////
//
// SND *psgfx_get_track ( u16 num )
//
//////////////////////////////////////////////////////////////////////////////////////
SND *psgfx_get_track ( u16 num ){
	return (SND*) &_PsgList[num];
}
...
{
	// song 00
	{ "   ",      (u8*) xgm01,    sizeof(xgm01) },
	{ "   ",      (u8*) xgm02,    sizeof(xgm01) },
	{ "   ",      (u8*) xgm03,    sizeof(xgm01) },
...
{
	// song 00
	{ "   ",      (u8*) pcm01,    sizeof(pcm01) },
	{ "   ",      (u8*) pcm02,    sizeof(pcm02) },
	{ "   ",      (u8*) pcm03,    sizeof(pcm03) },
	{ "   ",      (u8*) pcm04,    sizeof(pcm04) },
	{ "   ",      (u8*) pcm05,    sizeof(pcm05) },
	{ "   ",      (u8*) pcm06,    sizeof(pcm06) },
...
long SND_loadPcm_XGM(u8 sfx, u8 channel ){

    if( channel == 0 ){
        SND_setPCM_XGM(64, _PcmList[sfx].data, _PcmList[sfx].size);

        SND_startPlayPCM_XGM(64, 10, SOUND_PCM_CH2);
    }
    else if( channel == 1 ){
        SND_setPCM_XGM(65, _PcmList[sfx].data, _PcmList[sfx].size);
